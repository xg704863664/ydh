...
public class FormController {
    ...
    public ReturnJsonData<Map<String,Object>> findById(@ApiParam(value = "设计器id", required = true)@PathVariable(value = "designerId")  Long designerId,
                                                       @ApiParam(value = "本数据id", required = true)@PathVariable(value = "id")  String id){
    ...
    public ReturnJsonData delete(@ApiParam(value = "设计器id", required = true) @PathVariable(value = "designerId")  Long designerId,
                                 @ApiParam(value = "本数据id", required = true) @PathVariable(value = "id")  String id){
